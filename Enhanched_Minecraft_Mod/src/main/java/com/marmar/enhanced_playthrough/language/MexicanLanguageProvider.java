...
public class MexicanLanguageProvider extends AbstractModLanguageProvider{
    ...
    protected void addTranslations() {
        ...
        addItem(ModItems.SILVER_HELMET, "Yelmo de plata");
        ...
        addItem(ModItems.BRASS_HELMET, "Yelmo de latón");
        ...
        addItem(ModItems.BRONZE_HELMET, "Yelmo de bronce");
        ...
        addItem(ModItems.ROSE_GOLDEN_HELMET, "Yelmo de oro rosado");
        ...
        addItem(ModItems.BRONZIUM_HELMET, "Yelmo de broncio");
        ...
        addItem(ModItems.GREEN_GOLDEN_HELMET, "Yelmo de oro verde");
        ...
        addItem(ModItems.STEEL_HELMET, "Yelmo de acero");
        ...
        addItem(ModItems.PUMPKIN_FLOUR, "Harina de zapallo");
