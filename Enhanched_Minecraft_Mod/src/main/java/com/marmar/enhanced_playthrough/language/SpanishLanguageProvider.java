...
public class SpanishLanguageProvider extends AbstractModLanguageProvider{
    ...
    protected void addTranslations() {
        ...
        addAdvancementDesc("survival", "unity_makes_strength", "Craftee un horno de aleación");
        addAdvancementDesc("survival", "mighty_bronze", "Obten un pico de bronce");
        addAdvancementDesc("survival", "steel_isnt_enough", "Utilice su horno de aleación para fundir algo de acero");
        ...
        addAdvancementTitle("gems", "polish_diamond", "Estás aqui, Lucy?");
        ...
        addAdvancementDesc("gems", "polish_emerald", "Consiga algunas esmeraldas y cuidelas de los, ¿quienes?");
        addAdvancementDesc("gems", "polish_sapphire", "Consiga algunos safiros y visitá un rato el mar");
        addAdvancementDesc("gems", "polish_rubi", "Consiga algunos rubies y muestrele a los cerdos quién manda");
        addAdvancementDesc("gems", "polish_garnet", "Consiga algunos granates y demuestre su pasión");
        ...
        addBlock(ModBlocks.DEEPSLATE_TIN_ORE, "Mena de estaño profundo");
        addBlock(ModBlocks.ZINC_ORE, "Mena de zinc");
        addBlock(ModBlocks.DEEPSLATE_ZINC_ORE, "Mena de zinc profundo");
        addBlock(ModBlocks.NETHER_ZINC_ORE, "Mena de zinc del nether");
        addBlock(ModBlocks.NETHER_COPPER_ORE, "Mena de cobre del nether");
        addBlock(ModBlocks.SULFUR_ORE, "Mena de azufre");
        addBlock(ModBlocks.DEEPSLATE_SULFUR_ORE, "Mena de azufre profundo");
        addBlock(ModBlocks.NETHER_SULFUR_ORE, "Mena de azufre del nether");
        addBlock(ModBlocks.SILVER_ORE, "Mena de plata");
        addBlock(ModBlocks.DEEPSLATE_SILVER_ORE, "Mena de plata profundo");
        addBlock(ModBlocks.SAPPHIRE_ORE, "Mena de zafiro");
        addBlock(ModBlocks.DEEPSLATE_SAPPHIRE_ORE, "Mena de zaphiro profundo");
        addBlock(ModBlocks.RUBI_ORE, "Mena de rubi");
        addBlock(ModBlocks.DEEPSLATE_RUBI_ORE, "Mena de rubi profundo");
        ...
        addItem(ModItems.SILVER_CHESTPLATE, "Peto de plata");
        ...
        addItem(ModItems.BRASS_CHESTPLATE, "Peto de latón");
        ...
        addItem(ModItems.BRONZE_CHESTPLATE, "Peto de bronce");
        ...
        addItem(ModItems.ROSE_GOLDEN_CHESTPLATE, "Peto de oro rosado");
        ...
        addItem(ModItems.BRONZIUM_CHESTPLATE, "Peto de broncio");
        ...
        addItem(ModItems.GREEN_GOLDEN_CHESTPLATE, "Peto de oro verde");
        ...
        addItem(ModItems.STEEL_CHESTPLATE, "Peto de acero");
        ...
        addItem(ModItems.ZAPALLO_SEEDS, "Semillas de zapallo");
        addItem(ModItems.TOMATO_SEEDS, "Semillas de tomate");
        addItem(ModItems.CORN_SEEDS, "Semillas de maiz");
        ...
        addItem(ModItems.ZAPALLO, "Zapallo");
        addItem(ModItems.EGGPLANT, "Berenjena");
        addItem(ModItems.RICE_GRAINS, "Granos de arroz");

        //Cooked
        addItem(ModItems.COOKED_CORN, "Maiz cocido");
        addItem(ModItems.COOKED_ZAPALLO, "Zapallo cocido");
        ...
        addSmithingTranslations("bronzium", " Mejora de broncio", "Equipo de bronze, equipo de latón", "Lingote de latón, Lingote de bronce",
                "Coloca un arma, herramienta o armadora de bronce o de latón", "Coloca un Lingote de bronze para equipo de latón o un Lingote de latón para equipo de bronce");
