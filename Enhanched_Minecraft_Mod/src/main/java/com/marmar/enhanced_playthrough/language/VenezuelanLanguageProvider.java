...
public class VenezuelanLanguageProvider extends AbstractModLanguageProvider{
    ...
    protected void addTranslations() {
        ...
        addItem(ModItems.SILVER_HOE, "Azadón de plata");
        ...
        addItem(ModItems.BRASS_HOE, "Azadón de latón");
        ...
        addItem(ModItems.BRONZE_HOE, "Azadón de bronce");
        ...
        addItem(ModItems.ROSE_GOLDEN_HOE, "Azadón de oro rosado");
        ...
        addItem(ModItems.BRONZIUM_HOE, "Azadón de broncio");
        ...
        addItem(ModItems.GREEN_GOLDEN_HOE, "Azadón de oro verde");
        ...
        addItem(ModItems.STEEL_HOE, "Azadón de acero");
