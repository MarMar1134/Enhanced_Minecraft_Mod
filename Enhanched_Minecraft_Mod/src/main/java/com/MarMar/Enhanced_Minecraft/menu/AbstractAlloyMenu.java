...
public abstract class AbstractAlloyMenu extends AbstractContainerMenu {
    ...
    public AbstractAlloyMenu(MenuType<? extends AbstractAlloyMenu> menuType, int containerID, Inventory inv, FriendlyByteBuf extraData){
        this(menuType, containerID, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()),
                new SimpleContainerData(5));
    }
    public AbstractAlloyMenu(MenuType<? extends AbstractAlloyMenu> menuType, int containerID, Inventory inv, BlockEntity entity, ContainerData data){
