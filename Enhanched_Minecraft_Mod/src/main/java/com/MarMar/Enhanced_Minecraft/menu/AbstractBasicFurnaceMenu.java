...
import com.MarMar.Enhanced_Minecraft.block.custom.entity.AbstractBasicFurnaceBlockEntity;
...
public abstract class AbstractBasicFurnaceMenu extends AbstractContainerMenu {
    public final AbstractBasicFurnaceBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public AbstractBasicFurnaceMenu(MenuType<? extends AbstractBasicFurnaceMenu> menuType, int containerID, Inventory inv, FriendlyByteBuf extraData){
        this(menuType, containerID, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()),
                new SimpleContainerData(4));
    }
    public AbstractBasicFurnaceMenu(MenuType<? extends AbstractBasicFurnaceMenu> menuType, int containerID, Inventory inv, BlockEntity entity, ContainerData data){
        super(menuType, containerID);
        blockEntity = ((AbstractBasicFurnaceBlockEntity) entity);
