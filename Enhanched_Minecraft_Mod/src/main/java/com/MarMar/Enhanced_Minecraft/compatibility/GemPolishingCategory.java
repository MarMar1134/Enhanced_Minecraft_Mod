...
public class GemPolishingCategory implements IRecipeCategory<GemPolisherRecipe> {
    ...
    public static final RecipeType<GemPolisherRecipe> GEM_POLISHING_TYPE = new RecipeType<>(UID, GemPolisherRecipe.class);
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, GemPolisherRecipe recipe, IFocusGroup iFocusGroup) {
