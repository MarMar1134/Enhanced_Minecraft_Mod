...
public class ModTiers {
    ...
    public static final Tier Reinforced_diamond = TierSortingRegistry.registerTier(
            new ForgeTier(4, 1816, 8.5F, 3f, 12,
                    BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ModItems.Reinforced_diamond.get())),
            new ResourceLocation(Enhanced_Minecraft.MOD_ID, "reinforced_diamond"), List.of(Tiers.DIAMOND),
