...
public class SuperAlloyingFurnaceMenu extends AbstractContainerMenu {
    public final SuperAlloyingFurnaceBlockEntity blockEntity;
    ...
    public SuperAlloyingFurnaceMenu(int containerID, Inventory inv, BlockEntity entity, ContainerData data){
        super(ModMenuTypes.super_alloying_furnace_menu.get(), containerID);
        blockEntity = ((SuperAlloyingFurnaceBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.Super_alloying_furnace.get());
    }
