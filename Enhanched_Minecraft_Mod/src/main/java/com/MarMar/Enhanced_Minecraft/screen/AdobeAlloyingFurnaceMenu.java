...
public class AdobeAlloyingFurnaceMenu extends AbstractContainerMenu {
    public final AdobeAlloyingFurnaceBlockEntity blockEntity;
    ...
    public AdobeAlloyingFurnaceMenu(int containerID, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        blockEntity = ((AdobeAlloyingFurnaceBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.Adobe_alloying_furnace.get());
    }
